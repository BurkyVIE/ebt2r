...
theme_ebt <- function(...)
  ...
  theme(legend.position = "top",
        ...
        plot.subtitle = element_text(size = 12, face = "italic", color = rgb(45, 56, 81, maxColorValue = 255)),
...
raw <- raw %>%
  mutate(DateStamp = lubridate::force_tz(DateStamp, "Europe/Vienna"))
...
# Einlesen Rohdaten
raw <- read_lines(file = "script/EBT-Hits.csv", skip = 1, progress = FALSE, lazy = FALSE)
